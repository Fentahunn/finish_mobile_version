...
**[Portfolio: finish mobile version]** is a project where no complex coding is required and the only goal here is to master all of the tools and best practices we learned at Microverse.
...
- **[There will be  a form that will be used to contact the developer.]**
